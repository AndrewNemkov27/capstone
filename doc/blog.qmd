...
```{python}
#| label: Q1-scatter
#| fig-cap: "Scatter Plot: OCR Confidence vs. Word Length"
...
```{python}
#| label: Q1-box
#| fig-cap: "Box Plot: OCR Confidence vs. Japanese Character Type"
...
```{python}
#| label: Q1-heat
#| fig-cap: "Heatmap: Correlation of Word Characteristics"
...
```{python}
#| label: Q2-bar1
#| fig-cap: "Bar graph showing top 50 most frequent nouns across three Baki manga series."
...
```{python}
#| label: Q2-bar2
#| fig-cap: "Bar graph of normalized distributions of POS across three Baki manga series."
...
```{python}
#| label: Q2-bar3
#| fig-cap: "Bar graph top 20 most important words across three Baki manga series."
...
```{python}
#| label: Q3-bar
#| fig-cap: "Bar graph showing distribution of themes across three Baki manga series."
